...
ZiiPOSdownloadUrl = "https://download-myposzero.ziicloud.com/programs/ziipos/MyPosZeroLocalServerSetup(v2.6.3.9).exe"
...
( NAME = N'ZiiPOS_DB', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL10_50.SQLEXPRESS2008R2\MSSQL\DATA\MYPOSZero_DB.mdf' , SIZE = 3072KB , FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'ZiiPOS_DB_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL10_50.SQLEXPRESS2008R2\MSSQL\DATA\MYPOSZero_DB.ldf' , SIZE = 1024KB , FILEGROWTH = 10%)
GO
...
def AnydeskInstallationProcess(directory):
    ...
    if (file_exists==True):
        ...
        os.system(runCMD1)
        runCMD2='cmd /c echo Mypos123! | "C:\Program Files (x86)\AnyDeskMSI\AnyDeskMSI.exe" --set-password'
        os.system(runCMD2)
    else:
...
class App:
    def __init__(self, root):
        ...
        #setting title
        root.title("MyPOS F&B Deployment Tool V1.6")
        #setting window size
        width=350
        height=300
